...
import com.beibei.house_search.utils.CollUtils;
import com.beibei.house_search.utils.Convert;
...
public class PageDTO<T> {
    ...
    public static <T,R> PageDTO<T> of(Page<R> page, Function<R,T> function){
        if (page==null) {
            return new PageDTO<>();
        }
        if (CollUtil.isEmpty(page.getRecords())) {
